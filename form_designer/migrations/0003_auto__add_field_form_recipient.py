...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Form.recipient'
        db.add_column('form_designer_form', 'recipient',
                      self.gf('django.db.models.fields.CharField')(default='project.cch@tangentlabs.co.uk', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Form.recipient'
        db.delete_column('form_designer_form', 'recipient')
